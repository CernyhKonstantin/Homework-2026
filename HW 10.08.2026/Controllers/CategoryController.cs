...
public class CategoryController : ControllerBase
{
    ...
    [HttpGet("root")]
    public async Task<IActionResult> GetRoot() => Ok(await _service.GetRootCategoriesAsync());
    ...
    public async Task<IActionResult> GetChildren(int id) => Ok(await _service.GetChildrenAsync(id));
