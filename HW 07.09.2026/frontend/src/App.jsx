...
export default function App() {
  ...
  if (!auth) {
    return <main className="page"><header><h1>HW 07.09.2026</h1><p>Category & Product Creation</p></header><LoginForm onLogin={setAuth} /><div className="hint">Default seeded admin: <strong>admin@example.com</strong> / <strong>ChangeMe123!</strong></div></main>;
  }

  return (
    <main className="page">
      <header className="topbar"><div><h1>HW 07.09.2026</h1><p>React Hook Form + ASP.NET Core + SQL Server</p></div><div className="user"><span>{auth.email} · {auth.role}</span><button className="secondary" onClick={logout}>Logout</button></div></header>
