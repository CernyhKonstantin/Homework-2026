...
namespace HW_12._09._2026.Controllers;
...
public class AuthController : ControllerBase
{
    ...
    {
        var result = await _auth.ExternalResponseAsync(dto, Response, cancellationToken);

        if (result == null)
        {
            return BadRequest("External authentication data is invalid or the provider account is already linked to another user.");
        }
