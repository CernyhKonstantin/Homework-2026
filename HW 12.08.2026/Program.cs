...
using HW_10._08._2026.Helpers;
using HW_10._08._2026.Repositories;
using HW_10._08._2026.Repositories.Interfaces;
using HW_10._08._2026.Services;
...
builder.Services.AddStackExchangeRedisCache(options =>
{
    options.Configuration = builder.Configuration.GetConnectionString("Redis")
        ...
        ?? "localhost:6379";
    options.InstanceName = builder.Configuration["Redis:InstanceName"] ?? "HW10082026:";
});
